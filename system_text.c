...
{
	printf ("#######################################################################\n");
	printf ("####################### SAMBAHSA HEHLPER v 0.10 #######################\n");
	printf ("#######################################################################\n");
}
...
void help (short int lang)
{
	switch (lang)
	{
		...
		case 1:
			...
			printf ("\ntos programme, is hiebt id hehlp ios creator ios bahsa, is franceois");
			printf ("\nOlivier Simon");
			...
			printf ("\n    Dayir id transcriptor, yu naudhte gwupes quar jects in ment:");
			...
			printf ("\n    woid an id werd est pure Sambahsa au ne.");
			...
			printf ("\n");
			printf ("\n* \"log\": enwehrct au swehrct ia programmes messages. Tod est un baygh");
