...
void help (short int lang)
{
	switch (lang)
	{
		...
		case 1:
			...
			printf ("\n* \"pnc\" au \"pronunce\": dahsiet id pronunciation ios insert werd");
			...
			printf ("\n* \"cjg\" au \"conjuge\": dahsiet id conjugation ios insert werd");
			printf ("\n    * Mathalan: \"cjg edd\"");
		...
		case 2:
			...
			printf ("\n* \"pnc\" or \"pronunce\": will give the pronunciation of the inserted word");
			...
			printf ("\n* \"cjg\" or \"conjuge\": will give the conjugation of the inserted word");
			printf ("\n    * For example: \"cjg edd\"");
		...
		case 4:
			...
			printf ("\nO objetivo deste programa " SMALL_E_ACUTE " ajudar iniciantes exibindo a");
			printf ("\npron" SMALL_U_ACUTE "ncia e conjuga" SMALL_C_CEDILLA SMALL_A_TILDE "o das palavras.");
			printf ("\n\nEis os comandos:\n");
			...
			printf ("\n* \"pnc\" ou \"pronunce\": dar" SMALL_A_ACUTE " a pron" SMALL_U_ACUTE "ncia da palavra inserida");
			...
			printf ("\n    composta!");
			printf ("\n* \"cjg\" ou \"conjuge\": dar" SMALL_A_ACUTE " a conjuga" SMALL_C_CEDILLA SMALL_A_TILDE "o da palavra inserida");
			printf ("\n    * Por examplo: \"cjg edd\"");
...
void command_not_found (short int lang)
{
	switch (lang)
	{
		default:
		case 1:
			printf ("\nCommande ne trohven. In fall os doubt, neud id command \"helhp\"\n");
		break;
		case 2:
			printf ("\nCommand not found. In case of doubt, use the command \"help\"\n");
		break;
		case 4:
			printf ("\nComando n" SMALL_A_TILDE "o encontrado. Em caso de d" SMALL_U_ACUTE "vida, use o comando \"ajuda\" para obter ajuda\n");
		break;
	}
}
...
void invalid_argument (short int lang)
{
	switch (lang)
	{
		default:
		case 1:
			printf ("\nInvalid argument. In fall os doubt, neud id command \"helhp\"\n");
		break;
		case 2:
			printf ("\nInvalid argument. In case of doubt, use the command \"help\"\n");
		break;
		case 4:
			printf ("\nArgumento inv" SMALL_A_ACUTE "lido. Em caso de d" SMALL_U_ACUTE "vida, use o comando \"ajuda\" para obter ajuda\n");
		break;
	}
}
