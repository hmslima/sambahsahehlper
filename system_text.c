...
{
	printf ("###############################################################################\n");
	printf ("########################### SAMBAHSA HEHLPER v 0.31 ###########################\n");
	printf ("###############################################################################\n");
}
...
void help (short int lang)
{
	switch (lang)
	{
		...
		case 1:
			...
			printf ("\n    anghen. Tod programme khact native-ye transcribe un werd kam \"defend\" ob id");
			printf ("\n    khact gvaedde od tod werd est composen (hat un prefixe).");
		...
		case 2:
			...
			printf ("\n    conscious person. This program cannot natively transcribe a word like");
			printf ("\n    \"defend\" because the program cannot guess that this is a compound word");
			printf ("\n    (it has a prefix).");
		...
		case 4:
			...
			printf ("\n    pessoa consciente. Este programa n" SMALL_A_TILDE "o pode transcrever nativamente uma");
			printf ("\n    palavra como \"defend\" porque o programa n" SMALL_A_TILDE "o pode adivinhar que esta");
			printf ("\n    palavra " SMALL_E_ACUTE " composta (tem um prefixo).");
		...
		case 10:
			...
			printf ("\n    konscia persono. " CAPITAL_C_CIRCUMFLEX "i tiu programo ne povas krude transskribi ion kiel la");
			printf ("\n    vorton \"defend\" " SMALL_C_CIRCUMFLEX "ar la programo ne povas diveni ol " SMALL_C_CIRCUMFLEX "i vorto estas kombinata");
			printf ("\n    (tio havas prefikson).");
