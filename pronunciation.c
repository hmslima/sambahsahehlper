			...
			***************************************************************************/
			...
			else if (argument[arg_counter] == 'e')
			{
				...
				else
				{
					...
					//ehC\0 || eh\0
					if (!(stress) && (is_there_more_than_one_vowel_ignoring_last_e ()) && (argument[arg_counter + 1] == 'h') && (is_it_consonant (argument[arg_counter + 2]) || argument[arg_counter + 2] == '\0'))
					{
